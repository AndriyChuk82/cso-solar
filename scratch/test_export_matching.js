...
async function testExportMatching() {
  ...
  console.log(`Parsed Helius export products: ${products.length}`);
  ...
  console.log(`Matched Helius export: ${matched}/${testItems.length}`);
}

testExportMatching().catch(console.error);
