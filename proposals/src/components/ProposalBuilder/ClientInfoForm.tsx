...
export function ClientInfoForm({
  ...
  return (
    <div className="dark:bg-slate-900 rounded-lg border border-[#f59e0b]/20 p-3 client-info-block" style={{ backgroundColor: '#faf5ec', WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' } as any}>
