...
import { History as HistoryIcon, X, Eye, Trash2, FileText, RefreshCw, Search } from 'lucide-react';
...
export function HistoryModal({ isOpen, onClose }: HistoryModalProps) {
  ...
  // Сортуємо та фільтруємо історію
          ...
          <div className="w-1/2 border-r border-gray-200 flex flex-col overflow-hidden">
            <div className="p-4 border-b border-gray-100">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Пошук за назвою або телефоном..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-9 pr-8 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition"
                />
                {searchQuery && (
                  <button
